...
Realization from
https://github.com/tmarino2/corralling_stoch_bandits/blob/main/Tsallis_INF.py
"""
import sys
import random
import math
...
class Tsallis_INF(AbstractAgent):
    ...
    def reset(self):
        self.__init__(self.num_arms, self.alpha)
    ...
    def update(self,action, loss_t, eta_t=None):
        # action == self.arm_t
